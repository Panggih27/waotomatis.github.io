...
$(document).ready(function () {
  ...
  var submenu_animation_speed = 200; // Functions
  ...
  var appMenu = function appMenu() {
    if ($('.horizontal-menu').length) {
      ...
      if ($(window).width() > 1199) {
        ...
        ps = new PerfectScrollbar(container); // Hide all sub-menus
    ...
    var select_sub_menus = $('.accordion-menu li:not(.open) ul'),
        active_page_sub_menu_link = $('.accordion-menu li.active-page > a'); // Hide all sub-menus
    ...
    if (!$('.app').hasClass('menu-off-canvas')) {
      ...
      $(window).resize(function () {
        if ($(window).width() < 1199 && !$('.app').hasClass('sidebar-hidden')) {
          ...
          $('.fas .fa-angle-left i').text('last_page');
        } else {
          $('.hide-sidebar-toggle-button i').text('first_page');
        }
      });
    ...
    function toggleSidebar() {
      ...
      if ($('.app').hasClass('sidebar-hidden')) {
        ...
        if ($(window).width() > 1199) {
          $('#arrow-toggle').removeClass('fa-angle-left');
          $('#arrow-toggle').addClass('fa-angle-right');
        } else {
          console.log('arrow-top-else');
          $('#arrow-toggle').removeClass('fa-angle-right');
          $('#arrow-toggle').addClass('fa-angle-left');
        }
      } else {
  ...
  var components = function components() {
    if ($('.content-menu').length) {
      var container = document.querySelector('.content-menu');
